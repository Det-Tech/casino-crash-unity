...
public class TrailDrawer : MonoBehaviour {
   ...
   public LineRenderer line;
    ...
    public Vector2 AddPoint() {
        ...
        //DrawQuadraticBezierCurve(d, c, lastPoint.position - transform.position);
    ...
    void updateVertices() {
        ...
        //    float t = i / (float)points.Count;
        //    var _pos = DrawQuadraticBezierCurve(t,transform.position,point2.transform.position, points[i].transform.position);
        //    line.SetPosition(i, _pos);
        //}
